          ...
          <div class="row g-0">
            ...
            <div class="col-11 col-md-10 col-lg-9 mx-auto">
              ...
              if(isset($_REQUEST["submit"])){
                ...
                $check = mysqli_query($conn, "SELECT * FROM otpp WHERE otp = '$otp' OR email = '$email' ");
            ...
            location.href = 'otp.php?email = $email'</script>";
              }
              ...
              ?>
                ...
                <div class="mb-3 icon-group icon-group-end">
                  <input type="email" class="form-control bg-light border-light" id="emailAddress" required="" placeholder="Email Address" name="email">
                  <span class="icon-inside text-muted"><i class="fas fa-envelope"></i></span>
				</div>
        
                <div class="mb-3 icon-group icon-group-end">
                  <input type="hidden" class="form-control form-control-lg bg-light border-light" id="otp" required="" placeholder="otp" name= "otp" value= "<?php echo"$OTP"; ?>">
                ...
                <div class="d-grid my-4">
                  <button class="btn btn-dark btn-lg" type="submit" name= "submit">Sign Up</button>
                </div>
